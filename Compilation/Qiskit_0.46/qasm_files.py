# @Time: 2025/9/1 14:34    @Author: P1zza
# import matplotlib
...
# files = sorted(Path(args.qasm_path).glob("*.qasm"))
# if args.limit and len(files) > args.limit:
#     files = files[:args.limit]
# if not files:
#     raise FileNotFoundError(f"No QASM matched by glob: {args.qasm_path}")
# files = sorted(Path("B23/").glob("*.qasm"))
