...
def plot_cx_bar(Pass: str, in_path: str, out_path: str):
    # ----------------------- Config -----------------------

    IN_CSV = Path(in_path)
    OUT_DIR = Path(out_path)
    if Pass == "routing":
        FIG_PATH = OUT_DIR / "routing_cx_norm_bar.png"
    else:
        FIG_PATH = OUT_DIR / "mapping_cx_norm_bar.png"
...
if __name__ == "__main__":
    ...
    plot_cx_bar("mapping", "../results/b23_Tokyo20_mapping.csv", "../results")
    plot_cx_bar("routing", "../results/b23_Tokyo20_routing.csv", "../results")
